...
<body>
	...
	<div class="footer">
		Copyright &copy; 2012-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="" target="_blank">Platform</a> ${fns:getConfig('version')}
	</div>
