...
<head>
	...
	<style type="text/css">
		#main {padding:0;margin:0;} #main .container-fluid{padding:0 10px 0 16px;}
			...
			$("#menu a.menu").click(function(){
				...
				if ($(menuId).length > 0){
					...
					$.get($(this).attr("data-href"), function(data){
						...
						// 展现三级
						$(menuId + " .mypanel-body a").click(function(){
...
<div id="main">
	<nav id="header" class="navbar navbar-inverse navbar-fixed-top">
        ...
        <div class="navbar-header">
        	<span><img title="元度集团" width="130px;" style="margin-top: 12px;"  src="${ctxStatic}/images/logo.png"></span>
        </div>
    ...
    <div class="container-fluid">
			<div id="content" class="row">
				...
				<div id="right">
					<iframe id="mainFrame" name="mainFrame" src="" style="overflow:visible; scrolling=yes; frameborder=no; width=100%; min-heigh:650px; height=650px;"></iframe>
				</div>
			</div>
		    <div id="footer" class="row">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="" target="_blank">Platform</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
		var leftWidth = 165; // 左侧窗口大小
		...
		function wSize(){
			...
			mainObj.css("width",strs[1] < minWidth ? minWidth - 20 : "auto");
