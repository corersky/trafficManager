 ...
 * 数据Entity类
 */
public abstract class DataEntityTree<T> extends BaseEntity<T> {
	...
	protected Long pid; // 所有父级编号
	protected String name; 	// 机构名称
	protected Integer sort;		// 排序
	
	public DataEntityTree() {
		super();
		this.delFlag = DEL_FLAG_NORMAL;
	}
	
	public DataEntityTree(Long id) {
		super();
		this.id = id;
	}
    ...
    public boolean equals(Object obj) {
        ...
        DataEntityTree<?> that = (DataEntityTree<?>) obj;
